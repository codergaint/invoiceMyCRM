                                ...
                                <div class="tab-pane fade active show row">
                                    <div class="col-12">
                                        ...
                                        <form class="form my-4" method="POST" action="{{ route('updateSixthBox') }}" enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden" name="boxId" value="{{ $sixthBox->id }}">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        <label for="sixthBoxHeading" class="form-label">Box Heading</label>
                                                        <input type="text" class="form-control" placeholder="Enter sixthBox headline" id="sixthBoxHeading" value="{{ $sixthBox->title }}" name="boxHeading">
                                                    </div>
                                                </div><!--end col-->
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        <label for="sixthBoxText" class="form-label">Box Text</label>
                                                        <textarea class="form-control" placeholder="Enter Box text" id="sixthBoxText" name="boxText">{{ $sixthBox->description }}</textarea>
                                                    </div>
                                                </div><!--end col-->
                                                <div class="col-lg-12">
