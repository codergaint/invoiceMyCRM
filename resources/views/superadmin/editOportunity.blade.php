        ...
        <div class="col-xl-11 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif  
                    <p class="text-muted">Update <code>section 6</code> box using this page</p>
                    <div class="row">
                        <div class="col-lg-3">
                                ...
                                <div class="tab-pane fade active show row">
                                    <div class="col-12">
                                        ...
                                        <form class="form my-4" method="POST" action="{{ route('updateSixthBox') }}" enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden" name="boxId" value="{{ $oprotunity->id }}">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        <label for="oprotunityHeading" class="form-label">Box Heading</label>
                                                        <input type="text" class="form-control" placeholder="Enter oprotunity headline" id="oprotunityHeading" value="{{ $oprotunity->title }}" name="boxHeading">
                                                    </div>
                                                </div><!--end col-->
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        <label for="oprotunityText" class="form-label">Box Text</label>
                                                        <textarea class="form-control" placeholder="Enter Box text" id="oprotunityText" name="boxText">{{ $oprotunity->description }}</textarea>
                                                    </div>
                                                </div><!--end col-->
                                                <div class="col-lg-12">
