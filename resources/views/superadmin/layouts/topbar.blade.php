@php
    $profile = \App\Models\AdminPanel::find(Session::get('adminAuth'));
                        ...
                        <div data-simplebar style="max-height: 320px;">
                            ...
                            <div class="notification-list">
                                ...
                                <a href="javascript:void(0);" class="d-flex dropdown-item notify-item py-2">
                                    <img src="{{ asset('public/assets/images/avatar/avatar-2.jpg') }}" class="me-3 rounded-circle avatar-xs"
                                        alt="user-pic">
                                    <div class="flex-1">
                                ...
                                <!-- item -->
                                <a href="javascript:void(0);" class="d-flex dropdown-item notify-item py-2">
                                    <img src="{{ asset('public/assets/images/users/avatar-3.jpg') }}" class="me-3 rounded-circle avatar-xs"
                                        alt="user-pic">
                                    <div class="flex-1">
                                ...
                                <!-- item -->
                                <a href="javascript:void(0);" class="d-flex dropdown-item notify-item py-2">
                                    <img src="{{ asset('public/assets/images/users/avatar-5.jpg') }}" class="me-3 rounded-circle avatar-xs"
                                        alt="user-pic">
                                    <div class="flex-1">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        ...
                        @case('ru')
                            <img src="{{ asset('public/assets/images/flags/russia.svg') }}" class="rounded" alt="Header Language"
                                height="18">
                        @break
                        @case('it')
                            <img src="{{ asset('public/assets/images/flags/italy.svg') }}" class="rounded" alt="Header Language"
                                height="18">
                        @break
                        @case('sp')
                            <img src="{{ asset('public/assets/images/flags/spain.svg') }}" class="rounded" alt="Header Language"
                                height="18">
                        @break
                        @case('ch')
                            <img src="{{ asset('public/assets/images/flags/china.svg') }}" class="rounded" alt="Header Language"
                                height="18">
                        @break
                        @case('fr')
                            <img src="{{ asset('public/assets/images/flags/french.svg') }}" class="rounded" alt="Header Language"
                                height="18">
                        @break
                        @case('gr')
                            <img src="{{ asset('public/assets/images/flags/germany.svg') }}" class="rounded" alt="Header Language"
                                height="18">
                        @break
                        @default
                            <img src="{{ asset('public/assets/images/flags/us.svg') }}" class="rounded" alt="Header Language" height="18">
                    @endswitch
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a href="{{ url('index/gr') }}" class="dropdown-item notify-item language" data-lang="gr"
                            title="German">
                            <img src="{{ asset('public/assets/images/flags/germany.svg') }}" alt="user-image" class="me-2 rounded"
                        ...
                        <div data-simplebar style="max-height: 300px;">
                            <div class="p-2">
                                <div class="d-block dropdown-item text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('public/assets/images/products/img-1.png') }}"
                                ...
                                <div class="d-block dropdown-item text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('public/assets/images/products/img-2.png') }}"
                                            class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                ...
                                <div class="d-block dropdown-item text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('public/assets/images/products/img-3.png') }}"
                                            class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                ...
                                <div class="d-block dropdown-item text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('public/assets/images/products/img-6.png') }}"
                                            class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                ...
                                <div class="d-block dropdown-item text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('public/assets/images/products/img-5.png') }}"
                                            class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                                <a href="apps-ecommerce-product-details"
                        ...
                        <div class="tab-content" id="notificationItemsTabContent">
                            ...
                            <div class="tab-pane fade p-4" id="alerts-tab" role="tabpanel" aria-labelledby="alerts-tab">
                                <div class="w-25 w-sm-50 pt-3 mx-auto">
                                    <img src="{{ asset('public/assets/images/svg/bell.svg') }}" class="img-fluid" alt="user-pic">
                                </div>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="@if(empty($profile->avatar)) {{ asset('public/assets/images/users/avatar-1.jpg') }} @else {{ asset('public/assets/images/admin/') }}/{{ $profile->avatar }} @endif"
                                alt="Header Avatar">
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">@if(empty($profile->name)) Avatar @else {{ $profile->name }} @endif</span>
